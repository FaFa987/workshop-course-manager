...
public class StudentManager implements StudentService {
    ...
    public StudentView create(CreateStudentForm form) {
        ...
        Student creat = studentDao.createStudent(form.getName(), form.getEmail(), form.getAddress());
        return converters.studentToStudentView(creat);
    ...
    public boolean deleteStudent(int id) {
        ...
        for (Course course : courseDao.findAll()) {
            if (course.getStudents().contains(studentToDelete)) {
                course.unEnrollStudent(studentToDelete);
            }
        }
